 ...
 * 
 * @ClassName: User
 * @Description: TODO 登陆注册时传的是user类对象
 * @author TwoDaysZzz
 * @date 2021年5月18日
 *
 */
...
public class User implements Serializable {
	 ...
	 *            用户类型（管理员/普通用户）
	 */
	public User(int id, String name, String pwd, String gender, String email, String remarke,
	...
	public User(String name, String pwd, String gender, String email, String signature, String headImg, Date birthday) {
		this.name = name;
		this.pwd = pwd;
		this.gender = gender;
		this.email = email;
	...
	public User(int id, String name, String pwd, String gender, String email, Date birthday) {
		super();
		this.id = id;
		this.name = name;
		this.pwd = pwd;
