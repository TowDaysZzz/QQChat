...
public class MyTextPane {
	...
	public void addText(String text, SimpleAttributeSet font) {
		try {
			...
			// StyleConstants.setIcon(getMyAttribute(),
			// MyTools.getIcon("../img/QQ_64.png"));
	 ...
	 * @return 返回获取的字体
	 */
	public static SimpleAttributeSet getFontAttribute(String name, int size, Color color, boolean bold,
			boolean underline) {
