...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		label.setIcon(new ImageIcon(MainFrame.class.getResource("/client/img/QQ_settings_1.png")));
		...
		tabbedPane.addTab("\u597D\u53CB", new ImageIcon(MainFrame.class.getResource("/client/img/friend_list.png")),
				friendList, null);
		...
		menuItemSendInstantMessage.setIcon(new ImageIcon(MainFrame.class.getResource("/client/img/QQ_64.png")));
		...
		tabbedPane.addTab("\u7FA4\u7EC4", new ImageIcon(MainFrame.class.getResource("/client/img/friend_qun.png")),
				groupChat, null);
		...
		tabbedPane.addTab("\u6700\u8FD1", new ImageIcon(MainFrame.class.getResource("/client/img/friend_history.png")),
				recentlyChat, null);
		buttomMode.setLayout(null);

		userinfomation.setLayout(null);
		headImg = new JLabel("");
		headImg.setIcon(new ImageIcon(MainFrame.class.getResource("/client/img/head_boy_01_64.jpg")));
