...
import client.msgHandler.ChatChatListenr;
...
public class ChatFrame extends JFrame {
	...
	// }
	@Autowired
	private ChatChatListenr chatChatListenr;
	...
	public void initComponents() {
		...
		// }
		// });
		jButtonSend.addMouseListener(chatChatListenr);
		System.out.println("添加监听器成功" + chatChatListenr + "///////////////");
