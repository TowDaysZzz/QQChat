...
//@Component
public class ClientNettyFrame extends LoginFrame {
	/**
	 * 重连频率，单位：秒
	 */
	...
	public void send(MsgObject msgObject) {
		...
		logger.info("[send][msg({})]" + msgObject.getMessage());
		// 发送消息
